...
export const checkVideoExists = async (videoUrl) => {
    // If it's an external URL (Cloudinary, etc.), assume it exists
    // We can't do a proper HEAD request due to CORS, so just trust it
    if (videoUrl && (videoUrl.startsWith('http://') || videoUrl.startsWith('https://'))) {
        console.log('External video URL detected, skipping validation:', videoUrl);
